...
jQuery( function() {
    ...
    function TRP_Settings_Language_Selector() {
        ...
        this.initialize = function () {
            ...
            jQuery( '.trp-col-remove-language .trp-remove-language__container' ).click( _this.remove_language );
...
function TRP_Advanced_Settings_Tabs() {
    function init() {
        ...
        let containers = document.querySelectorAll(".trp-settings-container");
        ...
        function showTargetContainer(targetClass) {
            ...
            let targetContainers = document.querySelectorAll(`.trp-settings-container-${targetClass}`);
